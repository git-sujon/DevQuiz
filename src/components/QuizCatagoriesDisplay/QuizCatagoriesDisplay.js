            ...
            <Link to={`../quiz/${id}`}>
                <div className="flex justify-center border ">
                    <div className="rounded-lg shadow-lg relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 px-6 py-4 transition-opacity duration-200 overly-bg bg-opacity-75 opacity-0 hover:opacity-100 text-white">
                            ...
                            <p className='flex items-center justify-center mt-10'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="text-orange-100 w-32 h-32 lg:w-16 lg:h-16  border-8 border-double rounded-full border-orange-400">
