...
const Footer = () => {
    return (
        <div className='footer-bg'>
            <footer className="  flex  items-center justify-between container px-4 mx-auto" >

            <div className=" text-white p-2" >
                    <p className='m-0 '><span className=''>© 2022 Copyright:</span> <Link className="font-bold text-white" href='/'>Sujon</Link></p>
                </div>

                <div className=" pt-9">
                    <div className="flex justify-end mb-9">
                        <a href="https://fb.com/" className="mr-9 text-white">
                            <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fab"
                        ...
                        <a href="https://twitter.com/" className="mr-9 text-white">
                            <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fab"
