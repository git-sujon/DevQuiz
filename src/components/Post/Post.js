...
const Post = () => {
    ...
    return (
        <div className='mb-44'>
            ...
            <ul className='list-decimal text-4xl container px-16 mx-auto'>
                <li>
                    <div className=' '>
                        <div className=" text-gray-700 text-4xl ">
                            <p className="grow px-4 py-3 font-medium border mb-8" >How does Context api work?</p>
                ...
                <li>
                    <div className='mt-16 '>
                        <div className=" text-gray-700 text-4xl ">
                            <p className="grow px-4 py-3 font-medium border mb-8">What is the purpose of React Router?</p>
                ...
                <li>
                    <div className='mt-16 '>
                        <div className=" text-gray-700 text-4xl ">
                            <p className="grow px-4 py-3 font-medium border mb-8" >What is useRef()?</p>
